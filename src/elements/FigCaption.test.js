...
describe('renders UI correctly', () => {
  test('FigCaption', () => {
    ...
    expect(container).toMatchInlineSnapshot(`
      ...
      .Main__Kohoan-sc-55dih-2 .c0 a:link,
      .Main__Kohoan-sc-55dih-2 .c0 a:visited {
      ...
      .Main__Kohoan-sc-55dih-2 .c0 a:focus,
      .Main__Kohoan-sc-55dih-2 .c0 a:hover {
        background: rgb(156,147,143);
        outline: none;
        text-shadow: none;
      }

      .Main__Kohoan-sc-55dih-2 .c0 a:active {
        background: none;
      }

      .Main__Kohoan-sc-55dih-2 .c0 a:visited:focus,
      .Main__Kohoan-sc-55dih-2 .c0 a:visited:hover {
        background: rgb(156,147,143);
        outline: none;
        text-shadow: none;
      }

      .Main__Kohoan-sc-55dih-2 .c0 a:visited:active {
        background: none;
      }
